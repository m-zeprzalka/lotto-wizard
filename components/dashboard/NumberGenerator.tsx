  ...
  const generujZestaw = () => {
    ...
    switch (wybranyAlgorytm) {
      ...
      case "mieszany":
        ...
        break
      case "balans":
        nowyZestaw = generujZBalansem(czestotliwosci) // ← Dodano parametr
        break
      default:
        nowyZestaw = generujMieszany(czestotliwosci)
    }
    ...
    <div className="space-y-6 md:space-y-8">
              ...
              return (
                <Card
                  ...
                  className={`relative overflow-hidden transition-shadow ${
                    index === 0 ? "border-primary shadow-md" : "hover:shadow-md"
                  }`}
                >
      ...
      <div className="p-4 bg-muted/50 rounded-lg border">
        <p className="text-sm text-muted-foreground leading-relaxed">
          <strong className="text-foreground">⚠️ Uwaga:</strong> Generator służy
          do eksperymentowania z różnymi algorytmami. Każde losowanie Lotto jest
          niezależne i całkowicie losowe — analiza statystyczna nie gwarantuje
          wygranej. Traktuj to jako narzędzie edukacyjne i zabawę matematyczną!
        </p>
      </div>
    </div>
  )
